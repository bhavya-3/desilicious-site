...
window.onload = function() {
  animateValue(document.getElementById("counter1"), 0, 150, 3000);
  animateValue(document.getElementById("counter2"), 0, 3000, 3000);
  animateValue(document.getElementById("counter3"), 0, 20, 3000);
  insert_recommended();
};
